-- ============================================
-- METABASED - PostgreSQL Schema for Local Development
...
-- INSERT INTO posts (user_id, caption, image_url, visibility) VALUES
--     ((SELECT id FROM users WHERE username = 'admin'), 'Welcome to Metabased!', 'https://picsum.photos/seed/1/800/800', 'public'),
--     ((SELECT id FROM users WHERE username = 'demo_user'), 'First post!', 'https://picsum.photos/seed/2/800/800', 'public');
